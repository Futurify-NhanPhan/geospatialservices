...
{
    [XmlType(TypeName = "PropertyIsLessThankOrEqualTo", Namespace = Declarations.OgcNameSpace), Serializable]
    [DataContract]
    public partial class PropertyIsLessThanOrEqualTo : BaseComparisonOps
    {
        [XmlIgnore]
        [DataMember]
