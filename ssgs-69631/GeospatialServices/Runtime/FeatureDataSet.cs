...
namespace GeospatialServices.Runtime
{
	/// <summary>
	...
	public class FeatureDataTable : DataTable, System.Collections.IEnumerable
	{
		...
		private void InitClass()
		{
			//this.columnFeatureGeometry = new DataColumn("FeatureGeometry", typeof(GeospatialServices.Geometries.Geometry), null, System.Data.MappingType.Element);
