...
{
    [XmlType(TypeName = "PropertyIsGreaterThanOrEqualTo", Namespace = Declarations.OgcNameSpace), Serializable]
    [DataContract]
    public partial class PropertyIsGreaterThanOrEqualTo : BaseComparisonOps
    {
        [XmlIgnore]
        [DataMember]
